...
import snd.komelia.AppDirectories.onnxRuntimeInstallPath
...
class DesktopOnnxRuntimeInstaller(private val updateClient: UpdateClient) : OnnxRuntimeInstaller {
    ...
    private fun getWebGpuDownloadInfo(): OnnxRuntimeDownloadInfo {
        ...
        return OnnxRuntimeDownloadInfo(
            ...
            downloadUrl = "https://github.com/Snd-R/komelia-onnxruntime/releases/download/webgpu-1.25.0/libonnxruntime.zip",
            extractFiles = listOf(
